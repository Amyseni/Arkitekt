...
** DO NOT EDIT! The original file is in "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h".
*/

#line 1 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
#pragma once
...
#endif
#line 20 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
//|.section code
#define DASM_SECTION_CODE 0
#define DASM_MAXSECTION 1
#line 21 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
//|.globals lbl_
enum
{
    lbl__func,
...
#line 22 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
...
#line 23 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
struct Action;
namespace Arkitekt
{
    struct FnBlock;
...
class register32;
template <typename T>
concept r32t = (std::_Is_any_of_v<T, _r8::__r8, _r16::__r16, _r32::__r32, xmm::__xmm> or (std::assignable_from<uint32_t &, const T &>) or ((std::assignable_from<int32_t &, const T &>) and (std::assignable_from<register32 &, const T &> or std::constructible_from<register32, const T &> or std::same_as<register32, T>)));
enum class cleanup : uint32_t
{
    caller = 0u,
    callee = 1u
};
...
namespace Arkitekt
{
    ...
    public:
        ...
        {
            _blocks.size() || [&]()
            { this->_blocks=std::unordered_map<CHashMapHash, FnBlock>(); return true; }();
            return *this;
        }
...
{
    void operator()(Arkitekt::Assembler *ptr, Operand auto toPush)
    {
        dasm_State **Dst = &ptr->dasm;
        if constexpr (imm32<decltype(toPush)>)
        {
            // immediate pop
            //|push aword[toPush.value]
            dasm_put(Dst, 0, toPush.value);
#line 633 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            ptr->stackOffset += sizeof(uintptr_t);
        }
...
#line 639 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
...
#line 648 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
                ptr->stackOffset += sizeof(uint32_t);
                break;
...
{
    void operator()(Arkitekt::Assembler *ptr)
    {
        dasm_State **Dst = &ptr->dasm;
        //|ret
        dasm_put(Dst, 17);
#line 667 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
    }
    void operator()(Arkitekt::Assembler *ptr, imm32 auto oper)
    {
        dasm_State **Dst = &ptr->dasm;
        //|ret uint32_t(oper)
        dasm_put(Dst, 19, uint32_t(oper));
#line 672 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
    }
    constexpr ret() {}
};
...
{
    void operator()(Arkitekt::Assembler *ptr, is_register auto target, imm32 auto value)
    {
        dasm_State **Dst = &ptr->dasm;
...
#line 685 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            break;
        case BITMASK_R32:
            //|add Rd(target.ToRegID()), uint32_t(value)
            dasm_put(Dst, 29, (target.ToRegID()), uint32_t(value));
#line 688 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            break;
        case BITMASK_R8:
            //|add Rb(target.ToRegID()), (unsigned char)uint32_t(value)
            dasm_put(Dst, 35, (target.ToRegID()), (unsigned char)uint32_t(value));
#line 691 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            break;
        case BITMASK_XMM: // invalid in 32bit mode(?)
            throw new std::bad_function_call;
            break;
...
{
    void operator()(Arkitekt::Assembler *ptr, Operand auto address)
    {
        dasm_State **Dst = &ptr->dasm;
...
#line 732 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
        }
        else if constexpr (std::same_as<std::remove_all_extents_t<decltype(address)>, RegisterIndex>)
        {
            ...
            auto counter = ptr->GetNextDynamicLabel(label.c_str());
            //|push =>counter
            //|push dword[Rd(address.ToRegID())+address.GetValue()]
            //|ret
            //|=>counter:
            dasm_put(Dst, 44, counter, (address.ToRegID()), address.GetValue(), counter);
#line 742 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
        }
        else if constexpr (is_register<decltype(address)>)
        {
            //|call Rd(address.ToRegID())
            dasm_put(Dst, 56, (address.ToRegID()));
#line 746 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
        }
    }
    constexpr ind_call() {}
};
...
{
    void operator()(Arkitekt::Assembler *ptr, Operand auto lhs, Operand auto rhs)
    {
        dasm_State **Dst = &ptr->dasm;
...
#line 761 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
...
#line 765 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
...
#line 769 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
...
#line 774 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
        }
...
#line 781 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
            else if constexpr (is_register<decltype(rhs)>)
            {
                //| mov Rd(lhs.ToRegID()), Rd(rhs.ToRegID())
                dasm_put(Dst, 118, (rhs.ToRegID()), (lhs.ToRegID()));
#line 785 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
            else if constexpr (imm32<decltype(rhs)>)
            {
                //| mov Rd(lhs.ToRegID()), (uint32_t)rhs
                dasm_put(Dst, 125, (lhs.ToRegID()), (uint32_t)rhs);
#line 789 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
            else if constexpr (is_address<decltype(rhs)>)
            {
                //| mov Rd(lhs.ToRegID()), aword[uint32_t(rhs)]
                dasm_put(Dst, 130, (lhs.ToRegID()), uint32_t(rhs));
#line 793 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
        }
...
#line 801 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
            else if constexpr (is_register<decltype(rhs)>)
            {
                //| mov dword[uint32_t(lhs)], Rd(rhs.ToRegID())
                dasm_put(Dst, 147, (rhs.ToRegID()), uint32_t(lhs));
#line 805 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
            else if constexpr (imm32<decltype(rhs)>)
            {
                //| mov dword[uint32_t(lhs)], uint32_t(rhs)
                dasm_put(Dst, 153, uint32_t(lhs), uint32_t(rhs));
#line 809 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            }
        }
    }
    constexpr mov() {}
...
{
    void operator()(Arkitekt::Assembler *ptr, Operand auto toPop)
    {
        dasm_State **Dst = &ptr->dasm;
...
#line 823 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            ptr->stackOffset -= sizeof(uintptr_t);
        }
...
#line 829 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            else
                //|pop aword[Rd(toPop.ToRegID())-toPop.GetValue()]
                dasm_put(Dst, 74, (toPop.ToRegID()), -toPop.GetValue());
#line 831 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
...
#line 840 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
                ptr->stackOffset -= sizeof(uint32_t);
                break;
            case BITMASK_XMM: // invalid in 32bit mode
            case BITMASK_R16: // invalid in 32bit mode
...
#line 852 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
            ptr->stackOffset -= sizeof(uint32_t);
        }
    }
    constexpr pop() {}
...
inline void Assembler::Begin(void ***_labels)
{
    ...
    *_labels = __labels;
    ...
    //|.code
    dasm_put(Dst, 162);
#line 898 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
    //|.align 0x10
    //|->_func:
    dasm_put(Dst, 164);
#line 900 "/nvme2/projects/Arkitekt/Arkitekt-master/Arkitekt/src/Arkitekt.h"
...
static void *CreateWrapper(const std::string_view &name, void *inPtrToWrap)
{
    ...
    DO_LOG4("%s %p", name.data(), fn);
    a.End();
    return fn->m_Fn;
}

template <typename TFn, bool NeedsCallerCleanup = true>
static void *CreateWrapper(const std::string_view &name, TFn inPtrToWrap)
{
    void *ptr;
...
template <typename TFn, bool NeedsCallerCleanup = true>
static void *CreateWrapper(const std::string_view &name, size_t offset, const std::string_view &moduleName)
{
