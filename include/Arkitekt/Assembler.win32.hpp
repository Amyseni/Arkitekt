...
** DO NOT EDIT! The original file is in "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h".
*/

#line 1 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
#pragma once
...
#endif
#line 20 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
//|.section code
#define DASM_SECTION_CODE	0
#define DASM_MAXSECTION		1
#line 21 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
//|.globals lbl_
enum {
  lbl__func,
  lbl__MAX
};
#line 22 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
...
#line 23 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
struct Action;
namespace Arkitekt
{
    struct FnBlock;
    ...
    **/
    ...
    public:
        ...
        **/
        ...
        std::unordered_map<uint32_t, uint32_t> LabelMapCurrent;
        ...
        {
            auto hash = murmurhash(name.data()) ^ murmurhash(typeid(FnType).name());
        ...
        {
            auto hash = murmurhash(name.data());
            LabelMapCurrent[hash] = nextlocal++;
            if (nextlocal >= maxlocals)
                dasm_growpc(&this->dasm, std::bit_floor(maxlocals*=1.6));
            return LabelMapCurrent[hash];
...
#line 632 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
...
#line 638 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
...
#line 647 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
...
struct ret : public _Ins
{
    void operator() (Arkitekt::Assembler* assembler)
    {
        ...
        //|ret
        dasm_put(Dst, 17);
#line 666 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
    }
...
#line 671 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
    }
    constexpr ret() {}
};
...
struct add : public _Ins
{
    void operator() (Arkitekt::Assembler* assembler, is_register auto target, imm32 auto value)
    {
        ...
        {
        case BITMASK_R16:
            //|add Rw(target.ToRegID()), (unsigned short)uint32_t(value)
            dasm_put(Dst, 22, (target.ToRegID()), (unsigned short)uint32_t(value));
#line 684 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
                break;
        case BITMASK_R32:
            //|add Rd(target.ToRegID()), uint32_t(value)
            dasm_put(Dst, 29, (target.ToRegID()), uint32_t(value));
#line 687 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
                break;
        case BITMASK_R8:
            //|add Rb(target.ToRegID()), (unsigned char)uint32_t(value)
            dasm_put(Dst, 35, (target.ToRegID()), (unsigned char)uint32_t(value));
#line 690 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
                break;
        case BITMASK_XMM:// invalid in 32bit mode(?)
            throw new std::bad_function_call;
            break;
...
#line 706 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
        }
...
#line 715 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
        }
        else if constexpr (is_register<decltype(address)>)
        {
            //|call Rd(address.ToRegID())
            dasm_put(Dst, 56, (address.ToRegID()));
#line 719 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
        }
    }
    constexpr  call() {}
};
...
#line 731 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
        }
        else if constexpr (std::same_as<std::remove_all_extents_t<decltype(address)>, RegisterIndex>)
        {
            // ?? call with no call instruction??
            // ?? AKA Look ma, ROP in REAL
            ...
            //|push =>counter
                ...
                //|=>counter:
                dasm_put(Dst, 44, counter, (address.ToRegID()), address.GetValue(), counter);
#line 742 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
        }
        else if constexpr (is_register<decltype(address)>)
        {
            //|call Rd(address.ToRegID())
            dasm_put(Dst, 56, (address.ToRegID()));
#line 746 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
        }
    }
    constexpr  ind_call() {}
};
...
#line 761 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
...
#line 765 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
...
#line 769 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
...
#line 774 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
        }
...
#line 781 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
            else if constexpr (is_register<decltype(rhs)>)
            {
                //| mov Rd(lhs.ToRegID()), Rd(rhs.ToRegID())
                dasm_put(Dst, 118, (rhs.ToRegID()), (lhs.ToRegID()));
#line 785 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
            else if constexpr (imm32<decltype(rhs)>)
            {
                //| mov Rd(lhs.ToRegID()), (uint32_t)rhs
                dasm_put(Dst, 125, (lhs.ToRegID()), (uint32_t)rhs);
#line 789 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
            else if constexpr (is_address<decltype(rhs)>)
            {
                //| mov Rd(lhs.ToRegID()), aword[uint32_t(rhs)]
                dasm_put(Dst, 130, (lhs.ToRegID()), uint32_t(rhs));
#line 793 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
        }
...
#line 801 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
            else if constexpr (is_register<decltype(rhs)>)
            {
                //| mov dword[uint32_t(lhs)], Rd(rhs.ToRegID())
                dasm_put(Dst, 147, (rhs.ToRegID()), uint32_t(lhs));
#line 805 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
            else if constexpr (imm32<decltype(rhs)>)
            {
                //| mov dword[uint32_t(lhs)], uint32_t(rhs)
                dasm_put(Dst, 153, uint32_t(lhs), uint32_t(rhs));
#line 809 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
        }
    }
    constexpr  mov() {}
...
#line 828 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            }
...
#line 849 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
                assembler->stackOffset -= sizeof(uintptr_t);
        }
...
#line 855 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
            else
                //|pop aword[Rd(toPop.ToRegID())-toPop.GetValue()]
                dasm_put(Dst, 74, (toPop.ToRegID()), -toPop.GetValue());
#line 857 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
...
#line 866 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
                    assembler->stackOffset -= sizeof(uint32_t);
                break;
            case BITMASK_XMM:// invalid in 32bit mode
            case BITMASK_R16:// invalid in 32bit mode
...
#line 878 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
                assembler->stackOffset -= sizeof(uint32_t);
        }
    }
    constexpr  pop() {}
...
inline void Assembler::Begin(void*** _labels)
{
    ...
    *_labels = __labels;
    ...
    //|.code
    dasm_put(Dst, 169);
#line 924 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
        //|.align 0x10
        //|->_func:
        dasm_put(Dst, 171);
#line 926 "/nvme2/projects/Arkitekt/LibArkitekt/include/Arkitekt/Assembler.h"
