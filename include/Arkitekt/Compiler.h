...
namespace Arkitekt {
    struct FnBlock {
        ...
        constexpr FnBlock(void* _mem, std::size_t _size, void* _fn): m_Mem(_mem), m_Size(_size), m_Fn(_fn) {}
    ...
    class Compiler {
        ...
        public:
            ...
            void End();
            void EmitHookPrologue(std::size_t _argc, bool isVoid, bool isCdecl);
            void EmitHookEpilogue(std::size_t _argc, bool isVoid, bool isCdecl);
